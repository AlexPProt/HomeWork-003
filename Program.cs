...
//_________________________________________Задание  2.2 унификация _________________________________
//Напишите программу, которая выводит нужную цифру заданного числа или сообщает, что такой цифры нет.
// Вводим в функцию доп параметр для вывода нужной цифры

int BackRazr (int inputN, int numPP)
    {
